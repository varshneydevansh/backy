...
- **Validation**:
  ...
  - `test:forms` verifies the rendered consent export panel, retention policy summary, export metadata, and export action for the registration template consent field.
