...
| Dynamic SEO | SEO variables per dynamic page/item | Page metadata exists; dynamic item variable pipeline absent | Add SEO templates, canonical/OG generation, sitemap, robots, redirects |
