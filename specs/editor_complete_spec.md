...
- ⚠️ Page templates
  ...
  - Shared starter page chrome now clones responsive overrides, shifts root responsive `y` values by the injected header offset, and gives header/footer brand, navigation, and action blocks tablet/mobile geometry so page content and chrome stay aligned across breakpoints.
