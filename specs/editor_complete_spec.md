...
- `test:editor-drag` verifies mobile and tablet layout plus layer visibility/lock override persistence, group-level reset/inheritance controls, desktop layout preservation, breakpoint switching, and reload hydration across text, image, video, icon, box/nested-container, columns, navigation, form, comment, repeater, embed, map, interactive component, code component, nested button, and select/checkbox/radio choice input elements.
- Responsive smoke verifies mobile/tablet CSS and canvas-relative visual geometry with thresholds, hit-testing, clipped snapshots, editor reload hydration, and public preview rendering for text, media, utility, box/nested-container, columns, navigation, form, comment, repeater, embed/map, interactive/code component, nested button, and select/checkbox/radio choice input components.
...
- **Remaining Improvements Needed:**
    - Broaden pixel-level screenshot comparison across remaining deeply nested/multi-level component states and cross-browser responsive combinations
...
- ⚠️ Responsive breakpoint editing
  ...
  - Mobile and tablet persistence plus thresholded editor/public visual geometry are covered for heading, image, video, icon, box/nested-container, columns, navigation, form, comment, repeater, embed, map, interactive component, code component, nested button, select/checkbox/radio choice inputs, built-in starter page templates, collection dataset list/detail pages, and saved reusable section canvas content; still needs broader pixel-level comparison across deeply nested/multi-level component states and cross-browser responsive combinations.
- Responsive smoke now also covers mobile/tablet columns, navigation, form, comment, repeater, embed/map, interactive/code, nested button, and choice-input layout overrides, reload hydration, and public preview CSS/visual geometry with clipped screenshots and hit-testing.
