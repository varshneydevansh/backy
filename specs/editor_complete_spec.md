...
- ⚠️ Page templates
  ...
  - Selecting a composed card/section can now apply matching child binding slots across descendants in one editor history step, including virtual record slug/URL targets for link slots.
