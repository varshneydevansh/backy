...
- ⚠️ Page templates
  ...
  - Page-create smoke now creates and reopens every built-in starter page template, including about, team, careers, product-detail, pricing, services, portfolio, events, privacy, terms, cookie-policy, accessibility-statement, refund-policy, shipping-policy, cart, checkout, order-confirmation, help-center, FAQ, blog-post, member-login, and member-account templates, and verifies seeded editable elements, chrome, canvas sizing, form/data-binding metadata, editor rendering, and mobile/tablet hosted-preview rendering with pixel-threshold screenshots.
