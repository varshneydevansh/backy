...
- ⚠️ Page templates
  ...
  - Page-create smoke now creates and reopens every built-in starter page template, including about and member-login templates, and verifies seeded editable elements, chrome, canvas sizing, form/data-binding metadata, editor rendering, and mobile/tablet hosted-preview rendering with pixel-threshold screenshots.
