...
- remaining: expand the last rich-text table/list edge-case coverage and broader responsive pixel-level QA beyond starter templates into saved reusable sections, dynamic templates, and additional component combinations
