...
- remaining: expand the last rich-text table/list edge-case coverage and broader responsive pixel-level QA across remaining deeply nested/multi-level component states and cross-browser responsive combinations
