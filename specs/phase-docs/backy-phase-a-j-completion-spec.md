...
- remaining: expand the last rich-text table/list edge-case coverage and broader responsive pixel-level QA into saved reusable sections and additional component combinations
