...
- `PATCH /api/sites/:siteId/manage/pages/:pageId`
  ...
  - Selected rendered elements expose quick layout controls for `x`, `y`, `width`, `height`, layer/z-index, rotation, and visibility; these patch the same top-level page element fields consumed by the public renderer.
