...
- `PATCH /api/sites/:siteId/manage/pages/:pageId`
  ...
  - Selected rendered elements expose quick appearance controls for text color, background color, border color/style/width, border radius, padding, font size, font weight, and text alignment; these patch the same page element props consumed by the public renderer.
