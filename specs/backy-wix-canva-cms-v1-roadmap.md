...
4. selecting a composed card/section can now apply matching child binding slots across descendant elements in one editor history step, including repeater collection/field props and virtual record URL/slug targets for link slots.
