...
4. public form/comment/media/manifest/OpenAPI/SDK routes with cache and contract headers, plus authenticated SDK site and page lifecycle helpers for custom builders
