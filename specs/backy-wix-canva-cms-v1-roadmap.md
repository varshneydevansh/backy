...
4. public form/comment/media/manifest/OpenAPI/SDK routes with cache and contract headers, plus authenticated SDK site, page, and blog-post lifecycle helpers for custom builders
