...
- **Current progress**:
  ...
  - The editor Data panel now renders those preset binding slots, applies matching selected-collection fields as real `dataBindings`, and the shared content/render-payload contracts preserve the slot metadata for custom frontend handoff.
