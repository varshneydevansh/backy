...
- **Current progress**:
  ...
  - Admin reusable-section APIs now persist saved canvas section patterns with category/tag/status filtering, and the editor library can save selected element trees plus reload/insert/rename/delete active saved sections as cloned editable canvas elements.
