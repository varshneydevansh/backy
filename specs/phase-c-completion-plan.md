...
- **Current progress**:
  ...
  - Shared starter-page chrome now keeps responsive content offsets and header/footer navigation geometry aligned when Backy injects editable site chrome into starter templates.
