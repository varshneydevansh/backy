...
- **Current progress**:
  ...
  - `ComponentLibraryItem` and nested preset children now support binding-slot metadata, and blog/content presets seed CMS field targets for titles, excerpts, images, URLs, taxonomy, and collection records without faking live `dataBindings`.
