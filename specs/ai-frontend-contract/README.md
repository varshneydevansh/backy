...
The SDK also exports `BackyManifestCollectionsRuntimeModule` and `BackyManifestReusableSectionsRuntimeModule`, and generated schema types now include structured manifest `collectionsRuntime` and `reusableSectionsRuntime` discovery next to the existing theme/live-management/forms-runtime/comments discovery coverage.
