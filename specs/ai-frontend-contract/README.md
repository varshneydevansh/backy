...
The SDK also exports `BackyManifestPagesRuntimeModule`, `BackyManifestCollectionsRuntimeModule`, and `BackyManifestReusableSectionsRuntimeModule`, and generated schema types now include structured manifest `pagesRuntime`, `collectionsRuntime`, and `reusableSectionsRuntime` discovery next to the existing theme/live-management/forms-runtime/comments discovery coverage.
