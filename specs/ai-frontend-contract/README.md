...
The SDK also exports `BackyManifestPagesRuntimeModule`, `BackyManifestBlogRuntimeModule`, `BackyManifestCollectionsRuntimeModule`, and `BackyManifestReusableSectionsRuntimeModule`, and generated schema types now include structured manifest `pagesRuntime`, `blogRuntime`, `collectionsRuntime`, and `reusableSectionsRuntime` discovery next to the existing theme/live-management/forms-runtime/comments discovery coverage.
