...
The SDK also exports `BackyManifestCollectionsRuntimeModule`, and generated schema types now include structured manifest `collectionsRuntime` discovery next to the existing theme/live-management/forms-runtime/comments discovery coverage.
