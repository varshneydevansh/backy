...
includesAll(
  ...
  [
    ...
    'BACKY_CERTIFY_PUBLIC_API_ORIGIN',
    'BACKY_CORS_ALLOWED_ORIGINS',
	    'assertPublicApiCorsReady',
	    'assertSettingsAdminApiHandoff',
	    'assertSiteScopedSettingsApiHandoff',
	    ...
	    'commandPreviewTargetInputsIncludeSettingsSiteSelector',
	    'commandPreviewTargetInputsIncludeCommerceSiteSelector',
	    'settingsAdminApi',
...
includesAll(
  ...
  [
    ...
    'BACKY_SETTINGS_CERTIFY_NOTIFICATION_PROVIDER',
    "BACKY_SETTINGS_CERTIFY_PUBLIC_API_CORS: ${{ inputs.certify_public_api_cors && '1' || '0' }}",
    'BACKY_SETTINGS_CERTIFY_PUBLIC_API_ORIGIN',
    'BACKY_SETTINGS_CERTIFY_SITE_ID',
    'BACKY_CORS_ALLOWED_ORIGINS',
    'BACKY_SETTINGS_CERTIFICATION_BASE_URL',
    'BACKY_SETTINGS_CERTIFICATION_OUTPUT: artifacts/backy-settings-provider-certification.json',
    ...
    '| /products | npm run ci:commerce-provider-certification |',
    '| /orders | npm run ci:commerce-provider-certification |',
...
includesAll(
  ...
  [
    ...
    'buildSettingsCertificationOperatorCommandTemplate',
...
includesAll(
  ...
  [
    ...
    'hasProviderCertificationReadinessSummary',
    'hasProviderRuntimeEvidence',
    'hasProviderRuntimeEvidenceCopy',
    'hasProviderCertificationEvidencePacket',
    'settings-provider-certification-evidence-packet',
    'backy.settings-provider-certification-evidence-packet.v1',
    'backy.settings-provider-certification-handoff.v1',
    'Provider credentials stay in deployment or CI environment variables',
    'runtimeEvidence',
...
includesAll(
  ...
  'Settings admin client provider certification bridge',
);
...
includesAll(
  ...
  [
    ...
    'externalBaseUrlConfigured',
	    ...
	    'BACKY_SETTINGS_CERTIFICATION_OUTPUT',
	    'backy.settings-provider-certification-artifact.v1',
	    'Settings certification admin API-handoff artifact update',
    ...
    'Settings provider certification evidence packet update',
	    'Settings admin client provider-certification bridge update',
	    'GET /api/admin/settings` now returns `data.settings.completionStatus',
	    'BACKY_SETTINGS_SOURCE_ONLY=1',
    'BACKY_SETTINGS_SMOKE_SOURCE_ONLY=1',
    'settings-source-only',
    'backy.settings-provider-certification-evidence-packet.v1',
    'providerCertification.operatorEvidencePacket',
    'getSettings()',
    'SettingsProviderCertificationHandoff',
    'npm run doctor:release-certification',
    ...
    'npm run ci:settings-provider-certification',
    'test:settings-provider-certification-preflight-contract',
    'explicitly selected storage, Vercel, notification, custom frontend Public API/CORS, and optional nested Commerce provider families',
    'Settings custom frontend CORS certification update',
    'BACKY_SETTINGS_CERTIFY_PUBLIC_API_CORS=1',
    'OPTIONS /api/sites',
    'x-backy-contract-version',
    'provider-family selection, exact custom frontend origin checks, external admin-key requirements, secret-boundary checks, and requested-provider diagnostics',
  ],
