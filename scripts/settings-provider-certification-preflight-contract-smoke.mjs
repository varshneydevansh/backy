...
includesAll(
  ...
  [
    ...
    'npm run test:partial-gate-preflights | npm run test:admin-contract-source | external target configured:',
...
includesAll(
  ...
  [
    ...
    'hasProviderRuntimeEvidence',
    'hasProviderRuntimeEvidenceCopy',
    'backy.settings-provider-certification-handoff.v1',
    'Provider credentials stay in deployment or CI environment variables',
    'runtimeEvidence',
    'settings-provider-certification-doctor-toggle',
...
includesAll(
  ...
  [
    ...
    'Settings admin API provider scenario evidence parity update',
