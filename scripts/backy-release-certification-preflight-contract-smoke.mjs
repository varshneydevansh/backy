...
includesAll(
  ...
  [
    ...
    '`/forms`: run `npm run ci:forms-postgres`',
    'Frontend manifest/OpenAPI/SDK APIs: run `npm run ci:sdk-postgres-smoke`',
    '`/settings` and Settings admin APIs: run `npm run ci:settings-provider-certification`',
    '`/products` and `/orders`: run `npm run ci:commerce-provider-certification`',
