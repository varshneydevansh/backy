...
includesAll(
  ...
  [
    ...
    '/forms | npm run ci:forms-postgres | npm run test:partial-gate-preflights | npm run test:admin-contract-source',
    'Frontend manifest/OpenAPI/SDK APIs | npm run ci:sdk-postgres-smoke | npm run test:partial-gate-preflights | npm run test:admin-contract-source',
    '/settings and Settings admin APIs | npm run ci:settings-provider-certification | npm run test:partial-gate-preflights | npm run test:admin-contract-source',
    '/products and /orders | npm run ci:commerce-provider-certification | npm run test:partial-gate-preflights | npm run test:admin-contract-source',
...
includesAll(
  ...
  [
    ...
    'Forms and comments are Ready locally with database-service certification pending',
    'Public API parity is locally guarded',
...
includesAll(
  ...
  [
    ...
    'ready baseline with SDK/Postgres certification gate',
