...
includesAll(
  ...
  [
    ...
    'COMMERCE_PROVIDER_CERTIFICATION_OUTPUT_ENV',
    'COMMERCE_PROVIDER_CERTIFICATION_OUTPUT_ARTIFACT',
...
includesAll(
  sdkSource,
  [
    'BackyProviderCertificationEvidencePacket',
    'GeneratedBackyOpenApiCommerceProviderCertification',
    'GeneratedBackyOpenApiCommerceStorefrontContract',
    'GeneratedBackyFrontendManifestCommerceProviderCertification',
    'operatorNextAction?:',
...
includesAll(
  ...
  [
    ...
    'assertCommerceApiHandoffs',
    'assertPublicCommerceApiHandoffs',
    'assertCommerceProviderCertification',
    'assertProductProviderApiHandoff',
    'assertOrderProviderApiHandoff',
    ...
    'commandPreviewTargetInputsIncludeSiteSelector',
    '/api/sites/${encodedSiteId}/manifest',
    '/api/sites/${encodedSiteId}/commerce/catalog?limit=1',
    '/api/sites/${encodedSiteId}/commerce/orders',
    '/commerce/products/${encodeURIComponent(productId)}/provider-sync',
    '/commerce/orders/analytics',
    'publicApis',
    'backy.commerce-catalog.v1',
    'backy.commerce-orders.v1',
    'backy.product-storefront-handoff.v1',
    'backy.product-design-readiness.v1',
    ...
    'FORBIDDEN_CERTIFICATION_ARTIFACT_FIELD_NAMES',
    'collectForbiddenArtifactFields',
    'assertNoForbiddenArtifactFields',
    ...
    'admin keys, external target URLs, provider credentials',
  ],
...
includesAll(
  ...
  [
    ...
    'BACKY_COMMERCE_CERTIFICATION_OUTPUT: artifacts/backy-commerce-provider-certification.json',
    'BACKY_COMMERCE_TAX_PROVIDER_URL',
...
assert(
  workflow.indexOf('- name: Run Commerce provider certification preflight') < workflow.indexOf('- name: Write non-secret Commerce certification summary') &&
    ...
    workflow.indexOf('- name: Run Commerce provider certification\n') < workflow.indexOf('- name: Upload Commerce provider certification evidence'),
  'Commerce provider certification workflow must run preflight, write the non-secret summary, run certification, then upload evidence.',
);
...
includesAll(
  ...
  [
    ...
    'backy-commerce-provider-certification-evidence',
    'artifacts/backy-commerce-provider-certification.json',
    'operator evidence packets with selected-family required inputs',
    'selected `siteId`, `siteSelectorEnv`',
    'BACKY_COMMERCE_CERTIFY_SITE_ID',
    'apiHandoffs.publicApis',
    '/api/sites/:siteId/manifest',
    '/api/sites/:siteId/commerce/catalog',
    '/api/sites/:siteId/commerce/orders',
    '.env.backy-commerce-provider-certification',
...
includesAll(
  ...
  [
    ...
    'operatorCommandTemplate',
    'products-provider-certification-readiness-summary',
    ...
    'products-provider-certification-site-target',
    ...
    'providerCertificationReadinessItems',
    'providerCertificationRuntimeGapDetail',
    'PRODUCT_PROVIDER_CERTIFICATION_OUTPUT_ENV',
    'PRODUCT_PROVIDER_CERTIFICATION_OUTPUT_ARTIFACT',
    'PRODUCT_PROVIDER_CERTIFICATION_ARTIFACT_PATH_ENV',
    'PRODUCT_PROVIDER_CERTIFICATION_ARTIFACT_REQUIRED_ENV',
    'PRODUCT_PROVIDER_CERTIFICATION_ARTIFACT_DOCTOR_COMMAND',
    ...
    'BACKY_COMMERCE_CERTIFICATION_OUTPUT',
    'artifacts/backy-commerce-provider-certification.json',
    'Secret boundary: no commerce provider credentials, customer payloads, private order payloads, or webhook bodies are copied.',
...
includesAll(
  ...
  [
    ...
    'buildProductProviderCertificationEvidencePacket',
    ...
    'captureSource',
    'expectedArtifacts',
    'Redacted operator attachment manifest only',
...
includesAll(
  ...
  [
    ...
    'operatorCommandTemplate',
    'orders-provider-certification-readiness-summary',
    'operatorEvidencePacket: providerCertificationEvidencePacket',
    'operatorNextAction',
    'orders-provider-certification-next-action',
    ...
    'orders-provider-certification-site-target',
    ...
    'providerCertificationReadinessItems',
    'providerCertificationRuntimeGapDetail',
    'ORDER_PROVIDER_CERTIFICATION_OUTPUT_ENV',
    'ORDER_PROVIDER_CERTIFICATION_OUTPUT_ARTIFACT',
    'ORDER_PROVIDER_CERTIFICATION_ARTIFACT_PATH_ENV',
    'ORDER_PROVIDER_CERTIFICATION_ARTIFACT_REQUIRED_ENV',
    'ORDER_PROVIDER_CERTIFICATION_ARTIFACT_DOCTOR_COMMAND',
    '[ORDER_PROVIDER_CERTIFICATION_OUTPUT_ENV, ORDER_PROVIDER_CERTIFICATION_OUTPUT_ARTIFACT]',
    'backy.commerce-provider-certification-env-template.v1',
    '.env.backy-commerce-provider-certification',
    'BACKY_COMMERCE_CERTIFICATION_ARTIFACT_PATH',
    'BACKY_COMMERCE_CERTIFICATION_ARTIFACT_REQUIRED',
    'Order certification readiness summary',
    'Runtime credentials',
    'Scenario coverage',
    'Artifact output',
    'Gate command',
    ...
    'BACKY_COMMERCE_CERTIFICATION_OUTPUT',
    'artifacts/backy-commerce-provider-certification.json',
    'Secret boundary: no commerce provider credentials, customer payloads, raw order payloads, payment references, addresses, or webhook bodies are copied.',
    'backy.order-provider-certification-evidence-packet.v1',
    'Redacted operator attachment manifest',
    'Scenario attachments',
    'redactionPolicy',
...
includesAll(
  ...
  [
    ...
    'buildOrderProviderCertificationEvidencePacket',
...
includesAll(
  ...
  [
    ...
    'operatorEvidencePacket',
    'operatorNextAction',
    'BACKY_COMMERCE_SOURCE_ONLY',
    'BACKY_PRODUCTS_SOURCE_ONLY',
    'BACKY_COMMERCE_SMOKE_SOURCE_ONLY',
    'commerce-source-only',
  ],
...
includesAll(
  ...
  [
    ...
    'BACKY_COMMERCE_CERTIFY_SITE_ID',
    'includesWebhookBodies: false',
    'BACKY_ORDERS_SOURCE_ONLY',
    'BACKY_ORDERS_SMOKE_SOURCE_ONLY',
    'BACKY_COMMERCE_ORDERS_SOURCE_ONLY',
    'orders-source-only',
  ],
...
includesAll(
  ...
  [
    ...
    'Products/Orders API provider evidence packet update',
    'BACKY_COMMERCE_SOURCE_ONLY=1',
    'BACKY_PRODUCTS_SOURCE_ONLY=1',
    'BACKY_ORDERS_SOURCE_ONLY=1',
    'BACKY_ORDERS_SMOKE_SOURCE_ONLY=1',
    'commerce-source-only',
    'orders-source-only',
    'backy.commerce-provider-certification-evidence-packet.v1',
    'backy.order-provider-certification-evidence-packet.v1',
    'operatorEvidencePacket',
    'Commerce provider certification API-handoff update',
    'Completion-status artifact verifier metadata now mirrors the stricter selected-site proof',
