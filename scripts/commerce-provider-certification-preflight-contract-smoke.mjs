...
includesAll(
  ...
  [
    ...
    'operatorEnvTemplate',
    'buildCommerceProviderCertificationEnvTemplate',
    'backy.commerce-provider-certification-env-template.v1',
    '.env.backy-commerce-provider-certification',
    'buildCommerceProviderCertificationCommand',
...
includesAll(
  ...
  [
    ...
    'operatorCommandTemplate',
    'operatorEnvTemplate',
    'commerceProviderCertificationEnvTemplate',
    'requiredInputs',
  ],
...
includesAll(
  ...
  [
    ...
    'BACKY_COMMERCE_CERTIFY_DISCOUNT',
    ...
    'requiredLocalDiscountProvider',
    "method: 'PATCH'",
    "runtime.taxProvider === 'http'",
    "runtime.shippingProvider === 'http'",
    "runtime.discountProvider === 'http'",
    "group.area === 'commerce'",
...
includesAll(
  ...
  [
    ...
    'buildProductProviderCertificationCommand',
    'operatorCommandTemplate',
    'products-provider-certification-command-builder',
    ...
    'products-provider-certification-external-target-input',
    'products-provider-certification-doctor-toggle',
    'products-provider-certification-command',
    'products-provider-certification-required-inputs',
    'BACKY_COMMERCE_CERTIFY_PAYMENT_PROVIDER',
    'BACKY_COMMERCE_CERTIFY_TAX_PROVIDER',
...
includesAll(
  ...
  [
    ...
    'buildOrderProviderCertificationCommand',
    'operatorCommandTemplate',
    'orders-provider-certification-command-builder',
    ...
    'orders-provider-certification-external-target-input',
    'orders-provider-certification-doctor-toggle',
    'orders-provider-certification-command',
    'orders-provider-certification-required-inputs',
    'BACKY_COMMERCE_CERTIFY_PAYMENT_PROVIDER',
    'Subscription lifecycle providers',
    'BACKY_RAZORPAY_KEY_ID/BACKY_RAZORPAY_KEY_SECRET or RAZORPAY_KEY_ID/RAZORPAY_KEY_SECRET',
    'BACKY_COMMERCE_DISCOUNT_PROVIDER_URL or COMMERCE_DISCOUNT_PROVIDER_URL',
