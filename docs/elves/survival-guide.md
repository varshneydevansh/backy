...
**Newest Spark finding:** Spark explorer `019e891c-1089-7410-8570-e3adfde06c16` identified the next highest-impact editor gap: Inspector/property-panel geometry edits should call the same persisted canvas auto-grow path as drag/resize commits so long pages stay saved after numeric layout edits.
