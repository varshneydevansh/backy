...
**Single next action:** Continue Batch 5 with site switcher/domain/subdomain discoverability, or Vercel project linkage if the user explicitly asks to mutate the Vercel account.
