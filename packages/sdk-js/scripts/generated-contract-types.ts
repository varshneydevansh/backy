...
const customFrontendAgentHandoff = {
  ...
  componentApiContract: {
    ...
    readableFieldPaths: ["element.id", "element.type", "element.props", "element.styles", "element.responsive", "element.children[]"],
    writableFieldPaths: ["element.props", "element.styles", "element.responsive", "content.editableMap"],
    componentFamilies: ["layout", "typography", "media", "forms", "interactive-components", "custom-code"],
    componentTypeContracts: [
      {
        ...
        apiReadable: true,
        apiWritable: true,
        propPaths: ["props.content", "props.level"],
        stylePaths: ["styles.*"],
      ...
      },
      {
        ...
        apiReadable: true,
        apiWritable: true,
        propPaths: ["props.src", "props.mediaId", "props.alt"],
        stylePaths: ["styles.*"],
        responsivePaths: ["responsive.mobile"],
        bindingPaths: ["bindingSlots[]"],
      ...
      },
      {
        ...
        apiReadable: true,
        apiWritable: true,
        propPaths: ["props.content", "props.href"],
        stylePaths: ["styles.*"],
        responsivePaths: ["responsive.mobile"],
        bindingPaths: ["bindingSlots[]"],
      },
      {
        ...
        apiReadable: true,
        apiWritable: true,
        propPaths: ["props.items", "props.navigationBinding"],
        stylePaths: ["styles.*"],
        responsivePaths: ["responsive.mobile"],
        bindingPaths: ["bindingSlots[]"],
      },
      {
        ...
        apiReadable: true,
        apiWritable: true,
        propPaths: ["props.formId", "props.fields"],
        stylePaths: ["styles.*"],
        responsivePaths: ["responsive.mobile"],
        bindingPaths: ["bindingSlots[]"],
      ...
      },
      {
        ...
        apiReadable: true,
        apiWritable: true,
        propPaths: ["props.collectionId", "props.titleField"],
        stylePaths: ["styles.*"],
        responsivePaths: ["responsive.mobile"],
        bindingPaths: ["bindingSlots[]"],
        supportsChildren: true,
      },
      {
        ...
        apiReadable: true,
        apiWritable: true,
        propPaths: ["props.resourceType", "props.resourceId"],
        stylePaths: ["styles.*"],
        responsivePaths: ["responsive.mobile"],
        bindingPaths: ["bindingSlots[]"],
      },
      {
        ...
        apiReadable: true,
        apiWritable: true,
        propPaths: ["props.registryId", "props.config"],
        stylePaths: ["styles.*"],
        responsivePaths: ["responsive.mobile"],
        bindingPaths: ["bindingSlots[]"],
      ...
      },
      {
        ...
        apiReadable: true,
        apiWritable: true,
        propPaths: ["props.code", "props.html"],
        stylePaths: ["styles.*"],
        responsivePaths: ["responsive.mobile"],
        bindingPaths: ["bindingSlots[]"],
        supportsCustomCode: true,
