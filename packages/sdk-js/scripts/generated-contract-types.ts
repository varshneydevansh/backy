...
const componentTypeContracts = [
  ...
  componentTypeContractFixture("audio", "media", "Audio", ["props.src", "props.mediaId", "props.caption", "props.transcript", "props.controls", "props.autoplay", "props.loop"], { src: "", mediaId: "", caption: "", transcript: "", controls: true, autoplay: false, loop: false }, { supportsMediaAssets: true }),
...
const customFrontendAgentHandoff = {
  ...
  contentCreation: {
    ...
    adminEntryPoints: {
      ...
      newsletterBlogBackyCanvas: "/blog/new?siteId=site_demo&starterTemplate=newsletter&templateSource=backy-canvas&focus=canvas",
    ...
    newsletter: {
      ...
      writingCanvas: "/blog/new?siteId=site_demo&starterTemplate=newsletter&templateSource=backy-canvas&focus=canvas",
  ...
  routing: {
    ...
    identifiers: {
      ...
      domainAliases: [{ host: "docs.example.com", status: "verified" }],
    ...
    subdomainRouting: {
      supported: true,
      model: "Treat every public host as a Backy custom domain/verification host or verified domainAliases host.",
      examples: ["blog.example.com", "docs.example.com", "shop.example.com"],
      sameSiteAliases: [{ host: "docs.example.com", status: "verified" }],
      recommendation: "Use domainAliases for same-site hosts and one Backy site per independent subdomain when content, navigation, SEO, or design tokens differ.",
    },
    customFrontendDeployment: {
      ...
      forbiddenEnv: ["Supabase service role keys", "database URLs", "Backy admin/session secrets", "provider API keys"],
    },
    agentRules: [
  ...
  deploymentTopology: {
    ...
    projects: {
      ...
      customFrontend: {
        ...
        browserSafeEnv: ["NEXT_PUBLIC_BACKY_API_BASE_URL", "NEXT_PUBLIC_BACKY_SITE_ID", "NEXT_PUBLIC_BACKY_SITE_PUBLIC_HOST"],
        serverSideEnv: ["BACKY_PUBLIC_API_BASE_URL", "BACKY_SITE_ID", "BACKY_SITE_PUBLIC_HOST"],
        domainAttachment: "Attach the public website host to the custom frontend Vercel project.",
        apiOriginPolicy: "Use backy-public as the API/render origin.",
