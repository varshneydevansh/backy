...
assert(agentHandoff.data.contentCreation?.blogChildStarterTemplates?.some((template) => template.id === 'gallery' && template.sections?.includes('Files')), 'customFrontendAgentHandoff() missing media/file blog child starter');
