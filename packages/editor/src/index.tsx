...
export { normalizeNestedRichTextLists, normalizeRichTextListIndent } from './listNormalization';
...
export const BackyEditor = ({
    ...
    const normalizedValue = useMemo(
        () => normalizeNestedRichTextLists(Array.isArray(value) ? value : []),
        [value]
    );
    ...
    const renderElement = (props: any) => {
        ...
        if (type === 'li') {
            const indent = normalizeRichTextListIndent(element) ?? 0;
