...
assert(elements.length === 2, 'Expected invalid legacy element to be skipped');
...
assert(index.order.join(',') === 'hero,hero_title,hero_image,hero_title_2', `Unexpected migrated order ${index.order.join(',')}`);
