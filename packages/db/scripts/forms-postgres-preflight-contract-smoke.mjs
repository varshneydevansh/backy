...
includesEvery(adminFormsSmoke, [
  ...
  'Forms scenario evidence must enumerate all scenarios',
  'databaseUrlConfigured',
  'readyForCertification',
...
includesEvery(audit, [
  ...
  'Forms Postgres command builder',
