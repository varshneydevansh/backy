        ...
        [`/api/sites/${site.id}/media`]: {
          get: {
            ...
            parameters: [
              ...
              { name: 'scope', in: 'query', schema: { type: 'string', enum: ['global', 'page', 'post'] } },
        ...
        schemas: {
          ...
          MediaAsset: {
            ...
            properties: {
              ...
              editableMetadata: { $ref: '#/components/schemas/MediaEditableMetadata' },
              responsive: {
                type: 'object',
                additionalProperties: false,
                properties: {
          ...
          MediaReferences: {
            type: 'object',
            additionalProperties: false,
            required: ['schemaVersion', 'global', 'scoped', 'scopes', 'pageIds', 'postIds', 'pages', 'posts', 'usageTypes', 'totalBindings'],
            properties: {
              schemaVersion: { type: 'string', const: 'backy.media.references.v1' },
              global: { type: 'boolean' },
              scoped: { type: 'boolean' },
              scopes: { type: 'array', items: { type: 'string', enum: ['global', 'page', 'post'] } },
              pageIds: { type: 'array', items: { type: 'string' } },
              postIds: { type: 'array', items: { type: 'string' } },
              pages: { type: 'array', items: { $ref: '#/components/schemas/MediaReferenceTarget' } },
              posts: { type: 'array', items: { $ref: '#/components/schemas/MediaReferenceTarget' } },
              usageTypes: { type: 'array', items: { type: 'string' } },
          ...
          MediaEditableMetadata: {
            type: 'object',
            additionalProperties: false,
            required: ['schemaVersion', 'title', 'altText', 'caption', 'tags', 'folderId', 'scope', 'scopeTargetId', 'visibility', 'metadata'],
            properties: {
              schemaVersion: { type: 'string', const: 'backy.media.editable-metadata.v1' },
          ...
          CommerceWebhookRequest: {
            ...
            properties: {
              id: { type: 'string' },
              type: { type: 'string', examples: ['checkout.session.completed', 'invoice.payment_succeeded', 'customer.subscription.updated', 'customer.subscription.paused', 'customer.subscription.resumed', 'customer.subscription.trial_will_end', 'customer.subscription.deleted', 'charge.refunded', 'payment_intent.payment_failed'] },
              data: {
                type: 'object',
                properties: {
