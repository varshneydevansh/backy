...
function assertAdminPageContentValidationSource() {
  ...
  assert(liveManageOverlay.includes('TEXT_ALIGN_OPTIONS') && liveManageOverlay.includes('inlineAppearanceFontSize'), 'live management overlay must expose typography appearance controls');
