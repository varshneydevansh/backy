...
const sdkSmokeSource = read("../../../packages/sdk-js/scripts/smoke.mjs");
...
includesAll(
  ...
  [
    ...
    "mediaStorageHandoff: mediaStorageHandoffContract",
    "themeDesignImpact: themeDesignImpactContract(settings)",
    "themeDesignImpactContract",
    ...
    "backy.completion-status.v1",
    "settings-admin-apis",
    "data.settings.completionStatus",
...
includesAll(
  ...
  [
    ...
    "backy.media.editable-metadata.v1",
    "MediaDeliveryPolicy",
    "backy.media-file-categories.v1",
  ],
  "Admin settings media-storage OpenAPI handoff",
);
...
includesAll(
  ...
  "Site settings media-storage OpenAPI handoff",
);
...
includesAll(
  ...
  "SDK generated settings media-storage handoff fixture",
);
...
includesAll(
  ...
  [
    ...
    "siteEndpoints",
    "/api/admin/sites/site_demo/media",
  ],
  "SDK generated site settings media-storage handoff fixture",
);

includesAll(
  sdkSmokeSource,
  [
    "adminSettings() missing media storage handoff",
    "backy.media-storage-handoff.v1",
    "mediaStorageHandoff?.endpointTemplates?.adminSignedUrl",
    "backy.media.organization.v1",
    "element.props.mediaOrganization",
    "mediaStorageHandoff?.privacy?.includesSecretValues === false",
  ],
  "SDK runtime admin settings media-storage handoff smoke",
);

includesAll(
  sdkSmokeSource,
  [
    "openapi() missing site settings media storage handoff",
    "adminSiteSettings() missing site-scoped media storage handoff",
    "adminSiteSettings() media storage handoff source drifted",
    "adminSiteSettings() media storage handoff missing resolved site media endpoint",
    "adminSiteSettings() media storage handoff leaked secret-value policy",
  ],
  "SDK runtime site settings media-storage handoff smoke",
);
...
includesAll(
  ...
  [
    ...
    "buildProviderCertificationScenarioEvidence",
    "buildProviderCertificationEvidencePacket",
    "SETTINGS_PROVIDER_CERTIFICATION_SCENARIOS",
    "scenarioEvidence",
    "operatorEvidencePacket",
    "settingsAdminApi",
    "siteScopedSettingsApi",
...
includesAll(
  ...
  [
    ...
    "Site Settings frontend database handoff update",
