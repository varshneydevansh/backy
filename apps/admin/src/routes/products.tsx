                ...
                <div className="mt-4 grid gap-3 lg:grid-cols-[minmax(0,1fr)_minmax(260px,0.7fr)]">
                  ...
                  <div className="rounded-lg border border-border bg-card p-3">
                    ...
                    <p className="mt-1 text-xs leading-5 text-muted-foreground">
                      Backy can capture private orders, calculate quote totals, create checkout-session handoffs, link customers, settle provider webhook events, and expose worker-safe reconciliation dry-runs. Provider API execution, automated refunds, and scheduled execution wiring remain deeper commerce backend work.
                    </p>
                    <Link
                      to="/orders"
